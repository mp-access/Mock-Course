...
class Task2B(TestCase):
    ...
    def test_doghouse(self):
        self.assertTrue(hasattr(self.exercise, "dog"), "You must declare a variable 'dog'")
        self.assertTrue(hasattr(self.exercise, "house"), "You must declare a variable 'house'")
